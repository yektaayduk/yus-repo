...
LM4F_DIR = CORE_LIB_DIR + '/lm4f'
LM4F_INC_DIR = LM4F_DIR + '/inc'
LM4F_DRIVERLIB_DIR = LM4F_DIR + '/driverlib'
...
REQUIRED_INCLUDE = '#include <lm4f120xl.h>'
...
def scanFirmwareLibs():
    libraries = []
    folders = glob.glob(USER_LIB_DIR + '/*') # scan all folders inside USER_LIB_DIR
