...
public class ColorTable {
    ...
    public ColorTable(){
        ...
        mGreenVals = new int[] {
				...
				108, 107, 107, 107, 106, 106, 105, 105, 104, 104,
				103, 103, 102, 102, 101, 101, 101, 100, 100, 99,
    ...
    public void calibrate(Scalar hsv2, Scalar hsv5){
    	...
    	double Hslope = (hsv5.val[0] - hsv2.val[0]) / (40 - 10); 
    	double Sslope = (hsv5.val[1] - hsv2.val[1]) / (40 - 10);
    	double Vslope = (hsv5.val[2] - hsv2.val[2]) / (40 - 10);
    	
    	//double BSlope
    	//y = m*x + b
    	//hsv5.val[0] = Hslope * 10 + b
    	double Hb = hsv2.val[0] - (Hslope*10); 
    	double Sb = hsv2.val[1] - (Sslope*10);
    	double Vb = hsv2.val[1] - (Vslope*10);
