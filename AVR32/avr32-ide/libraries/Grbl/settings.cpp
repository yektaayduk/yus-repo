...
void Grbl::Settings::clear_build_info() { eeprom_put_char(EEPROM_ADDR_BUILD_INFO , 0); }
...
uint8_t Grbl::Settings::store_global_setting(uint8_t parameter, float value) {
  ...
  if (parameter >= AXIS_SETTINGS_START_VAL) {
    ...
    switch(parameter) {
      ...
      case 2:
        ...
        parent->m_stepper.generate_step_dir_invert_masks(); // Regenerate step and direction port invert masks.
        break;
      case 3:
      ...
      case 21:
        ...
        parent->m_limits.init(); // Re-init to immediately change. NOTE: Nice to have but could be problematic later.
        break;
      case 22:
